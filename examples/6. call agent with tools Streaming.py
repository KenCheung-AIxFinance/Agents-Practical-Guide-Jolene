...
# ===== Values Mode =====
# for step in llm_agent.stream({"messages": [input_message]}, stream_mode="values"):
#     step["messages"][-1].pretty_print()

for step, metadata in llm_agent.stream({"messages": [input_message]}, stream_mode="messages"):
